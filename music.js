...
// include: /var/folders/6m/4r76rfk54ygbk5kf1v69_dwc0000gp/T/tmpwf0el7gf.js
  ...
  (() => {
    ...
    async function loadPackage(metadata) {
      ...
      var PACKAGE_NAME = 'build/web/music.data';
      var REMOTE_PACKAGE_BASE = 'music.data';
...
Module['FS_createPath']("/assets", "web", true, true);
      ...
      async function processPackageData(arrayBuffer) {
        ...
        Module['FS_createDataFile'](name, null, data, true, true, true);
          ...
          Module['removeRunDependency']('datafile_build/web/music.data');
      }
      Module['addRunDependency']('datafile_build/web/music.data');
    ...
    loadPackage({"files": [{"filename": "/assets/web/icon.svg", "start": 0, "end": 89}, {"filename": "/assets/web/music.html", "start": 89, "end": 1343}], "remote_package_size": 1343});

  })();

// end include: /var/folders/6m/4r76rfk54ygbk5kf1v69_dwc0000gp/T/tmpwf0el7gf.js
// include: /var/folders/6m/4r76rfk54ygbk5kf1v69_dwc0000gp/T/tmp_k9vdhgd.js

    // All the pre-js content up to here must remain later on, we need to run
    // it.
    if ((typeof ENVIRONMENT_IS_WASM_WORKER != 'undefined' && ENVIRONMENT_IS_WASM_WORKER) || (typeof ENVIRONMENT_IS_PTHREAD != 'undefined' && ENVIRONMENT_IS_PTHREAD) || (typeof ENVIRONMENT_IS_AUDIO_WORKLET != 'undefined' && ENVIRONMENT_IS_AUDIO_WORKLET)) Module['preRun'] = [];
    var necessaryPreJSTasks = Module['preRun'].slice();
  // end include: /var/folders/6m/4r76rfk54ygbk5kf1v69_dwc0000gp/T/tmp_k9vdhgd.js
// include: /var/folders/6m/4r76rfk54ygbk5kf1v69_dwc0000gp/T/tmphyvpzo99.js

    if (!Module['preRun']) throw 'Module.preRun should exist because file support used it; did a pre-js delete it?';
    necessaryPreJSTasks.forEach((task) => {
      if (Module['preRun'].indexOf(task) < 0) throw 'All preRun tasks that exist before user pre-js code should remain after; did you replace Module or modify Module.preRun?';
    });
  // end include: /var/folders/6m/4r76rfk54ygbk5kf1v69_dwc0000gp/T/tmphyvpzo99.js
